...
function Unsophisicated:CreateWindow(title)
    ...
    CloseBtn.Position = UDim2.new(0, 48, 0.5, -13)
    ...
    MinimizeBtn.MouseButton1Click:Connect(function()
        ...
        if minimized then
            tween(MainFrame, {Size = UDim2.new(0, MainFrame.Size.X.Offset, 0, 45)})
    ...
    function Window:CreateHomeTab()
        local home = self:AddTab("Home", "6026568251")
        ...
        local joinDateStr = date:FormatLocalTime("MM/DD/YYYY", "en-us")
