-- cred to xHeptc obv and this is just a modified kavo ui
...
local themeStyles = {
    ...
    SeaTheme = {
        SchemeColor = Color3.fromRGB(81, 106, 166),
        Background = Color3.fromRGB(59, 78, 125),
        Header = Color3.fromRGB(44, 61, 110),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(47, 63, 120)
    },
    Serpent = {
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "SeaTheme" then
        themeList = themeStyles.SeaTheme
